...
print(f"Gradient Boosting model training completed in {end_time - start_time:.2f} seconds.")
...
importances = pd.DataFrame({'Feature': features, 'Importance': gb_model.feature_importances_})
